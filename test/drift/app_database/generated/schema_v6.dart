...
class Accounts extends Table with TableInfo<Accounts, AccountsData> {
  ...
  late final GeneratedColumn<int> closingDayInCurrent = GeneratedColumn<int>(
...
class AccountsData extends DataClass implements Insertable<AccountsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['closing_day_in_current'] = Variable<int>(closingDayInCurrent);
  ...
  factory AccountsData.fromJson(
    ...
    return AccountsData(
      ...
      closingDayInCurrent: serializer.fromJson<int>(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'closingDayInCurrent': serializer.toJson<int>(closingDayInCurrent),
...
class AccountsCompanion extends UpdateCompanion<AccountsData> {
  ...
  final Value<int> closingDayInCurrent;
  ...
  static Insertable<AccountsData> custom({
    ...
    Expression<int>? closingDayInCurrent,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (closingDayInCurrent.present) {
      map['closing_day_in_current'] = Variable<int>(closingDayInCurrent.value);
    }
    if (dueDay.present) {
...
class AppSettingsData extends DataClass implements Insertable<AppSettingsData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, monthStartDay, themeMode, textScale, highContrast);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
